...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "mlf");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "mlb");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "mrf");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "mrb");

        leftFront.setDirection(DcMotorSimple.Direction.REVERSE); // reverse direction
        leftRear.setDirection(DcMotorSimple.Direction.REVERSE);
        motors = Arrays.asList(leftFront, leftRear, rightRear, rightFront);
        leftMotors = Arrays.asList(rightFront, rightRear);
        rightMotors = Arrays.asList(leftFront, leftRear);
